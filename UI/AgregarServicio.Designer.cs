namespace UI
{
    partial class AgregarServicio
    {
        ...
        private void InitializeComponent()
        {
			...
			// cant_Servicio
			// 
			this.cant_Servicio.Enabled = false;
			...
			this.dGV_ListadoAlojamientos.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dGV_ListadoAlojamientos.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.dataGridView_Servicio.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.dataGridView_Servicio.DefaultCellStyle = dataGridViewCellStyle7;
