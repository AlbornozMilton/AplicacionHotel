namespace UI
{
    partial class VisualizarAlojamiento
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox2.Controls.Add(this.lbl_Capacidad);
			this.groupBox2.Controls.Add(this.label3);
			this.groupBox2.Controls.Add(this.lbl_NroHabitacion);
			this.groupBox2.Controls.Add(this.label9);
			this.groupBox2.Controls.Add(this.lbl_planta);
			...
			this.lbl_Capacidad.Text = "unaCap";
			// 
			// label3
			// 
			...
			this.dGV_ClienteResponsable.MultiSelect = false;
